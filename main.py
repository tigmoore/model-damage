"""
Code adapted from https://github.com/VainF/Torch-Pruning to use evaluation
"""
...
def train_model(
    ...
    for epoch in range(epochs):
        ...
        if best_acc < acc:
            ...
            if args.mode == "prune":
                if save_as is None:
                    save_as = os.path.join( args.output_dir, "{}_{}_{}_{}.pth".format(args.dataset, args.model, args.method, args.speed_up) )
...
# these are personal modifications for chris K. so i dont finetune the compressed model
